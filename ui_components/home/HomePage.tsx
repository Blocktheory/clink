                ...
                <div className="bg-white p-6">
                    ...
                    <div className="rounded-lg border border-gray-500 p-4">
                        <div className="flex items-center justify-center">
                            <input
                                name={"usd value"}
                                className={`pl-0 pt-2 pb-1 border-none text-center dark:bg-transparent text-text-900 dark:text-textDark-900 placeholder-text-300 dark:placeholder-textDark-300 text-base rounded-lg block w-full focus:outline-none focus:ring-transparent`}
                                placeholder={"$0 USD"}
                                autoFocus={true}
                                onWheel={() =>
