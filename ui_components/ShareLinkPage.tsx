...
const ShareLink: FC<IShareLink> = (props) => {
  ...
  const handleRemove = async () => {
    ...
    const ethAdapter = new EthersAdapter({
      ethers,
      signerOrProvider: fromSigner,
    });
    const safeAddress = await fromSigner.getAddress();
      ...
      <div className="w-full h-[70%] text-center p-4  flex flex-col gap-5 items-center">
          ...
          <div className=" rounded-lg profileBackgroundImage flex flex-col justify-between h-full">
              ...
              <div className="flex justify-between">
                <div className="flex gap-1 flex-col text-start ml-3">
                  ...
                  <div className="flex justify-around w-[100px] mx-auto mt-1.5">
                    <Link href={`${SelectedChain.explorer.url}/address/${fromAddress}/#internaltx`} target="_blank">
                      <Image
                        src={icons.linkWhite}
                        alt="external link"
            ...
            <div className="self-end">
              {isClaimSuccessful || linkValueUsd === "$0" ? (
                <Image className="mt-[-29px]" src={icons.tchestopen} alt="Chest Open" />
              ) : (
        ...
        {linkValueUsd === "$0" ? (
          ...
          <>
            ...
            />
            {processing && (
              <p className="claim-processing">{"⏳ Hang tight! We're currently processing your claim."}</p>
            )}
          </>
        ) : (
          <>
