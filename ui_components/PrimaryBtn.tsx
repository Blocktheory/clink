...
export default function PrimaryBtn(props: IPrimaryBtn) {
  ...
  return (
    <button
      className={`py-4 btnBg support_text_bold rounded-lg flex gap-1 items-center w-full justify-center my-0 mx-auto max-w-[400px] border border-[#010101] text-[#010101] ${
