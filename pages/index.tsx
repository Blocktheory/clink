...
export default function Home() {
  ...
  const [safeApiService, setSafeApiService] = useState<SafeApiKit>();

  const deploySafeContract = async () => {
    console.log("at 214");
    const ethProvider = new ethers.providers.Web3Provider(provider!);
    console.log(
      "🚀 ~ file: index.tsx:216 ~ deploySafeContract ~ ethProvider:",
      ethProvider
    );
    const signer = await ethProvider.getSigner();
    console.log(
      "🚀 ~ file: index.tsx:218 ~ deploySafeContract ~ signer:",
      signer
    );
    ...
    console.log(
      "🚀 ~ file: index.tsx:223 ~ deploySafeContract ~ ethAdapter:",
      ethAdapter
    );
    ...
    setSafeApiService(safeService);
    const safeFactory = await SafeFactory.create({ ethAdapter: ethAdapter });
    console.log(
      "🚀 ~ file: index.tsx:225 ~ deploySafeContract ~ safeFactory:",
      safeFactory
    );
    ...
    console.log(
      "🚀 ~ file: index.tsx:230 ~ deploySafeContract ~ safeAccountConfig:",
      safeAccountConfig
    );
    ...
    const cntSDK = await safeSdk.connect({
      ethAdapter,
      safeAddress: await safeSdk.getAddress(),
    });
    console.log(
      "🚀 ~ file: index.tsx:272 ~ deploySafeContract ~ cntSDK:",
      cntSDK
    );
    setSafeSDK(cntSDK);

    console.log(
      "🚀 ~ file: index.tsx:241 ~ deploySafeContract ~ safeSdk:",
      safeSdk
    );
    // const sdkOwner = await safeFactory.deploySafe({
    //   safeAccountConfig,
    //   saltNonce: "122387989898882",
    // });
    // console.log(
    //   "🚀 ~ file: index.tsx:232 ~ deploySafeContract ~ sdkOwner:",
    //   sdkOwner
    // );
    // console.log(sdkOwner, "sdk owner");
    // const safeSdkOwnerPredicted = await safeFactory.predictSafeAddress(
    //   safeAccountConfig
    // );
    return cntSDK.getAddress();
  };
